...
int main(int argc, char **argv)
{
    ...
    /* Window title carries BOTH versions: the Dolphin it is based on and the
       Exxos patch level, so it is obvious at a glance whether an update has
       landed and which half of it changed. Reads e.g.
           Dolphin Exxos Edition (22.12.3 - Exxos 1.1) */
    const QString exxosName = i18n("Dolphin Exxos Edition (%1 - Exxos %2)",
                                   QStringLiteral(DOLPHIN_VERSION_STRING),
                                   QStringLiteral(EXXOS_EDITION_VERSION));
